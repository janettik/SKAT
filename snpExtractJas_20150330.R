...
#--------------------------------------------------------------------------------
load("C:/Users/JNettiksimmons/Documents/DATA/snpedia_20150330.rdata")
snpSelect = snpedia
...
save(mros_imp, file = "mros_imp_20150330.rdata")
...
save(sof_imp, file = "sof_imp_20150330.rdata")
...
save(mros_imp_clean, file = "mros_impC_20150330.rdata")

sof_imp_clean = cleanUp(sof_imp, mycohort = "SOF", mypop = 'White', impute = TRUE)
save(sof_imp_clean, file = "sof_impC_20150330.rdata")
