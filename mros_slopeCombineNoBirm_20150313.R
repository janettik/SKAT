...
#load("mros_genoC_20131122.rdata")
load("mros_impC_20150313.rdata")
#---------------------------format data---------------------------------------
...
save(mros_ci_nb, file = "mros_ci_noBirm_20150313.rdata")

#baseline imputed
mros_cib_nb = subset(mros_ci_nb, visit_order == 1)
save(mros_cib_nb, file = "mros_cib_noBirm_20150313.rdata")
